...
const cadastro = () => {
  ...
  const template = `
    <section class='box-text-img'>
      <div class='box-01'>
        <img src=${logocad}'./img/novalogosemfundo.png' alt='logo HelParents' class='img-logo'>
       <div class="paragrafo">
        <article>
      ...
      <div class='img-register'>
        <img src=${cadastroimg}'./img/op26.png' alt='img-cadastro' class='img-cadastro'>
      </div>
    </div>
    <section class='box-register'>
     <form class='section-register'>
...
const feed = () => {
  ...
  <header class="header">
   <div class="div-img-logo">
     <img class="logo-feed" src=${logo}'./img/lofeedsemfundo.png' alt='logo HelParents' class='img-logo'>
   </div>
