...
const fazerLogin = (email, senha) => signInWithEmailAndPassword(auth, email, senha);
const fazerCadastro = (email, senha, name2) => {
  const authentication = getAuth(app);
  return createUserWithEmailAndPassword(authentication, email, senha).then(() => updateProfile(authentication.currentUser, { displayName: name2 }));
};
const fazerLoginComGoogle = () => {
  const provider = new GoogleAuthProvider();
  return signInWithPopup(auth, provider);
};
const logocad = "/assets/novalogosemfundo.910db5dc.png";
const cadastroimg = "/assets/op26.5e797a2c.png";
const googlelogo = "data:image/png;base64,";
const login = () => {
  ...
  const template = `
    <section class='box-text-img'>
      <div class='box-01'>
        ...
        <div class="paragrafo">
          <article>
            <p>A <strong>HELParents</strong> \xE9 uma rede social para compartilhar informa\xE7\xF5es e orienta\xE7\xF5es ajudando pais e cuidadores sobre o uso da internet.</p>
            <p><strong>J\xE1 est\xE1 cadastrado? <br> Fa\xE7a o login!</strong></p>
          </article>  
        </div> 
      ...
      <section class='box-register'>
        <form class='section-register'>
          ...
          <div class="form-group">
            ...
            <hr>
            <p class='text-box-register'>Ainda n\xE3o tem conta?<p>
  ...
  btnLogin.addEventListener("click", (event) => {
    ...
    if (email.value === "") {
      showErrorMessage("Voc\xEA precisa preencher os dois campos abaixo", 4e3);
      return;
    }
    if (senha.value === "") {
      showErrorMessage("Voc\xEA precisa digitar uma senha", 4e3);
      return;
    }
    if (senha.value.length < 6) {
      showErrorMessage("Sua senha precisa ter pelo menos seis digitos", 4e3);
      return;
    }
    fazerLogin(email.value, senha.value).then(() => {
      window.location.hash = "#feed";
    }).catch(() => {
      const erroMsg = container.querySelector(".msg-erro");
      erroMsg.innerHTML = "Usu\xE1rio ou senha incorretos";
    });
  });
  const btnLoginGoogle = container.querySelector(".btn-logo-google");
  btnLoginGoogle.addEventListener("click", () => {
    fazerLoginComGoogle().then(() => {
      window.location.hash = "#feed";
    }).catch(() => {
    });
  });
...
const cadastro = () => {
  ...
  const template = `
    ...
    <section class='box-register'>
     <form class='section-register'>
       ...
       <input type='text' placeholder='Nome de Usu\xE1rio:' id='name-user'>
  ...
  btnCadastrar.addEventListener("click", (event) => {
    ...
    fazerCadastro(email.value, senha.value, nomeUsuario.value).then(() => {
      window.location.hash = "#feed";
    });
  });
...
const db = wh(app);
const salvarPost = async (date, id2, text, username) => {
...
const pegarPost = async () => {
  const mensage = [];
  const order = dl(sh(db, "posts"), Il("date", "desc"));
  const snapShot = await tf(order);
...
const editarPosts = async (postId, text) => {
  const atualizarPostsEditados = rh(db, "posts", postId);
  await rf(atualizarPostsEditados, {
    text
  });
};
const deletarPost = async (postId) => {
  of(rh(db, "posts", postId));
};
const logo = "/assets/lofeedsemfundo.af10ddbf.png";
const sair = "data:image/png;base64,";
const checked = "/assets/checked.144db942.png";
const user = "/assets/profile-user.7c7a26b3.png";
const editar = "data:image/png;base64,";
const deletar = "data:image/png;base64,";
const feed = () => {
  const container = document.createElement("div");
  const template = `
  <header class="header">
  ...
  <main>
    <div class="postando">
      ...
      <button class="btn-postar" id="bntPublicar">
          <img class='postar-img' src=${checked} alt='logo-google'>
      </button>
