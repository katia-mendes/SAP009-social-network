...
const logo = "/assets/novalogosemfundo.910db5dc.png";
const cadastro$1 = "/assets/op26.5e797a2c.png";
    ...
    <section class='box-text-img'>
      <div class='box-01'>
        ...
        <div class='img-register'>
          <img src=${cadastro$1} alt='img-cadastro' class='img-cadastro'>
        </div>
      </div>
...
const feed = () => {
    ...
    arrayPosts.forEach((post) => {
      if (post.userId === auth.currentUser.uid) {
        ...
        btnDeletar.addEventListener("click", (e) => {
          e.preventDefault();
          if (window.customConfirm("Tem certeza de que deseja excluir a publica\xE7\xE3o?")) {
    ...
    arrayPosts.forEach((post) => {
      if (post.userId === auth.currentUser.uid) {
        ...
        btnEditar.addEventListener("click", (e) => {
          e.preventDefault();
          if (window.customConfirm("Tem certeza de que deseja editar a publica\xE7\xE3o?")) {
  ...
  btnPublicar.addEventListener("click", () => {
    if (textArea.value !== "") {
      ...
      window.customConfirm("Por favor, preencha o campo de postagem!");
    }
  });
